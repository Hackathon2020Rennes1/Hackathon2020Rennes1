            ...
            return SafeArea(
              child: ListView(
                children: [
                  ...
                  if (snapshot.data['fields']['titre_fr'] != null) Padding(
                    ...
                    child: Column(
                      children: [
                        Column(
                          ...
                          children: [
                            if (snapshot.data['fields']['tranche'] != null) Row(
                              children: [
                                Icon(
                            ...
                            if (snapshot.data['fields']['adresse'] != null) Column(
                                children: [ Padding(
                            ...
                            if (snapshot.data['fields']['horaires_detailles_fr'] != null) Column(
                                children: [ Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                                  Row(
                            ...
                            if (snapshot.data['fields']['telephone_du_lieu'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                                  Row(
                            ...
                            if (snapshot.data['fields']['site_web_du_lieu'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                                  Row(
                                ...
                                children: [Padding(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      RatingBar.builder(
                                        initialRating: (snapshot.data['ratings'] != null && snapshot.data['ratings'][_firebaseUser.uid] != null) ? double.parse(snapshot.data['ratings'][_firebaseUser.uid].toString()) : 0,
                                        minRating: 1,
                                        ...
                                        onRatingUpdate: (rating) async {
                                          await snapshot.data.reference.update({'ratings.${_firebaseUser.uid}' : rating})
                                      ...
                                      RatingText(key: _ratingKey, id: _id, rateExist: snapshot.data['rate'] != null ? snapshot.data['rate'] as double :0,
                            ...
                            if (snapshot.data['fields']['thematiques'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 10),
                                ),
                            ...
                            if (snapshot.data['fields']['orientation_et_axes_transversaux'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['publics_concernes'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['inscription_necessaire'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['description_fr'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['organisateur'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['nom_du_lieu'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['tags_du_lieu'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['description_du_lieu_fr'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
                            ...
                            if (snapshot.data['fields']['acces_itineraire_fr'] != null) Column(
                                children: [Padding(
                                  padding: const EdgeInsets.only(top: 5),
                                ),
...
class _RatingTextState extends State<RatingText> {
  ...
  async {
    try {
      ...
      doc.get().then((doc) {if(doc.exists){
      ...
      await doc.update({'nb_votes' : _nbVotes})
          .then((value) => print("Votes Updated"))
          .catchError((error) => print("Failed to update votes: $error"));
      await doc.update({'rate' : _rate/_nbVotes})
